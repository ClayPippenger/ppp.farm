...
#
# Go to the R:\Shared\Website Archives\development\_Deployments\ppp.farm using Powershell
#
...
Set-Location "Y:\Website Archives\development\_Deployments\ppp.farm\photos"
...
if (Test-Path "..\Remove-DuplicatImages.ps1") {
    ...
    Write-Warning "Remove-DuplicatImages.ps1 not found in Y:\Website Archives\development\_Deployments\ppp.farm\"
}
...
if (Test-Path ".\script.ps1") {
    ...
    Write-Warning "script.ps1 not found in Y:\Website Archives\development\_Deployments\ppp.farm\photos"
}

# 6️⃣ Done
Write-Host "`n✅ Update complete. photos.json should now be ready in Y:\Website Archives\development\_Deployments\ppp.farm\"
Write-Host "`n✅ Will push everything to Git now..."

#Pause

Set-Location "Y:\Website Archives\development\_Deployments\ppp.farm\"
